...
import com.pub_sub_queue.handler.TopicHandler;
...
public class Queue {
    ...
    public void subscribe(@NonNull final ISubscriber subscriber, @NonNull final Topic topic){
        ...
        System.out.println(subscriber.getId() + " subcribed to topic: " + topic.getTopicName());
    }
    ...
    public void publish(@NonNull final Topic topic, @NonNull final Message message){
        ...
        // why in new thread, so that callers who are using this queue does not get blocked and continue their work or perform other operations on queue
